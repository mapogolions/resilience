...
type OnRetryFunc[S any, T any, R any] func(context.Context, resilience.PolicyOutcome[T], R)
...
func NewRetryCountPolicy[S any, T any](retryCount int, onRetry OnRetryFunc[S, T, int]) resilience.Policy[S, T] {
